            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                            ...
                            return __generator(this, function (_b) {
                                switch (_b.label) {
                                    ...
                                    case 3:
                                        ...
                                        if (!(payload &&
                                            payload.length >= sodium.crypto_secretbox_NONCEBYTES + sodium.crypto_secretbox_MACBYTES)) return [3 /*break*/, 7];
                                        _b.label = 4;
                                    case 4:
                                        _b.trys.push([4, 6, , 7]);
                    ...
                    case 4:
                        ...
                        _a.label = 5;
                    case 5:
                        if (!this.initialListener) return [3 /*break*/, 7];
                        ;
                        return [4 /*yield*/, this.client.promise];
                    case 6:
                        (_a.sent()).unsubscribe(MatrixClientEvent_1.MatrixClientEventType.MESSAGE, this.initialListener);
                        _a.label = 7;
                    case 7:
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.client.promise];
                    case 1:
                        (_a.sent()).unsubscribe(MatrixClientEvent_1.MatrixClientEventType.MESSAGE);
